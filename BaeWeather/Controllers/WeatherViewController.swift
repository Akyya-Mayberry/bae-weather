...
class WeatherViewController: UIViewController {
    ...
    private func updateUI() {
        ...
        let lowHighAttributedString: [NSAttributedString.Key: Any] = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 20.0), NSAttributedString.Key.foregroundColor: UIColor.white]
        let range = (weatherViewModel.tempsString as NSString).range(of: weatherViewModel.lowHighTempString)
        attributedString.addAttributes(lowHighAttributedString, range: range)
